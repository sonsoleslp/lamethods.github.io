## This file has been retrieved from https://github.com/Wallot/MdRQA/blob/master/mdrqa.R,
## the repository containing the additional resources to the article Wallot, S., Roepstorff, A.,
## & Mønster, D. (2016). Multidimensional Recurrence Quantification Analysis (MdRQA) for the
## analysis of multidimensional time-series: A software implementation in MATLAB and its 
## application to group-level data in joint action. *Frontiers in psychology*, 7, 1835. 
## DOI:[10.3389/fpsyg.2016.01835](https://doi.org/10.3389/fpsyg.2016.01835).
## ...and to the article Wallot, S. & Leonardi, G. (2018) Analyzing Multivariate Dynamics 
## Using Cross-Recurrence Quantification Analysis (CRQA), Diagonal-Cross-Recurrence Profiles (DCRP), 
## and Multidimensional Recurrence Quantification Analysis (MdRQA) – A Tutorial in R. Front. Psychol. 
## 9:2232. doi: [10.3389/fpsyg.2018.02232](https://doi.org/10.3389/fpsyg.2018.02232).
...
# General Public License version 2 or later (Free Software Foundation)
  ...
  diag(RP) <- 1
  RP = Matrix::Matrix(RP, sparse = TRUE)

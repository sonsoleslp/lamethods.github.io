...
1.  **Threshold**: Directly removes edges with weights below 0.05, offering a straightforward cutoff approach.
...
#| label: fig-pruned
#| fig-cap: "Pruning with different methods"
#| fig-subcap: 
#|    - "Threshold = 0.05"
#|    - "Lowest 15%"
#|    - "Disparity filter"
...
pruned_threshold <- prune(model, method = "threshold", threshold = 0.05)
...
```{r, echo = FALSE, fig.align='center',  layout=c(1,1,1), fig.width=3, fig.height=2.8}
#| label: fig-triads
#| fig-cap: "Identified triads"
#| fig-subcap: 
#|  - "Triad 1"
#|  - "Triad 2"
#|  - "Triad 3"
plot(cliques_of_three, vsize = 25, edge.label.cex = 1.4, esize = 15)
```
...
```{r, eval= FALSE, fig.align='center',  layout=c(1,1,1) , fig.width=4, fig.height=4}
plot(cliques_of_four)
```

```{r, echo = FALSE, fig.align='center',  layout=c(1,1,1), fig.width=4, fig.height=4}
#| label: fig-fours
#| fig-cap: "Identified quadruples"
#| fig-subcap: 
#|  - "Quadruple 1"
#|  - "Quadruple 2"
#|  - "Quadruple 3"
...
```{r, eval = FALSE, fig.align='center',  layout=c(1,1,1)}
plot(cliques_of_five)
```

```{r, echo = FALSE, fig.align='center', layout=c(1,1,1), fig.width=4, fig.height=4}
#| label: fig-fives
#| fig-cap: "Identified quintuples"
#| fig-subcap: 
#|  - "Quintuple 1"
#|  - "Quintuple 2"
#|  - "Quintuple 3"
...
#| fig-cap: "Communities detected using the `leading_eigen` algorithm"
communities <- communities(model)
...
```{r, cache=TRUE, fig.align='center', fig.width=7, fig.height=4}
#| label: fig-centrality-stability
#| fig-cap: "Results of the Case-Dropping Bootstrap for Centrality Indices"
